...
pub fn build(b: *std.Build) void {
    ...
    blinky_exe.setLinkerScript(b.path("stm32_hal/STM32C031XX_FLASH.ld"));
...
fn addHalCode(b: *std.Build, module: *std.Build.Module) void {
    ...
    const headers = .{
        "stm32_hal/Core/Inc",
        "stm32_hal/Drivers/STM32C0xx_HAL_Driver/Inc",
        "stm32_hal/Drivers/STM32C0xx_HAL_Driver/Inc/Legacy",
        "stm32_hal/Drivers/CMSIS/Device/ST/STM32C0xx/Include",
    ...
    module.addCSourceFiles(.{
        .files = &.{
            ...
            "stm32_hal/Core/Src/stm32c0xx_it.c",
            "stm32_hal/Core/Src/stm32c0xx_hal_msp.c",
            "stm32_hal/Drivers/STM32C0xx_HAL_Driver/Src/stm32c0xx_hal_cortex.c",
            "stm32_hal/Drivers/STM32C0xx_HAL_Driver/Src/stm32c0xx_hal.c",
            "stm32_hal/Drivers/STM32C0xx_HAL_Driver/Src/stm32c0xx_hal_rcc.c",
            "stm32_hal/Drivers/STM32C0xx_HAL_Driver/Src/stm32c0xx_hal_rcc_ex.c",
            "stm32_hal/Drivers/STM32C0xx_HAL_Driver/Src/stm32c0xx_hal_flash.c",
            "stm32_hal/Drivers/STM32C0xx_HAL_Driver/Src/stm32c0xx_hal_flash_ex.c",
            "stm32_hal/Drivers/STM32C0xx_HAL_Driver/Src/stm32c0xx_hal_gpio.c",
            "stm32_hal/Drivers/STM32C0xx_HAL_Driver/Src/stm32c0xx_hal_dma.c",
            "stm32_hal/Drivers/STM32C0xx_HAL_Driver/Src/stm32c0xx_hal_dma_ex.c",
            "stm32_hal/Drivers/STM32C0xx_HAL_Driver/Src/stm32c0xx_hal_pwr.c",
            "stm32_hal/Drivers/STM32C0xx_HAL_Driver/Src/stm32c0xx_hal_pwr_ex.c",
            "stm32_hal/Drivers/STM32C0xx_HAL_Driver/Src/stm32c0xx_hal_exti.c",
            "stm32_hal/Drivers/STM32C0xx_HAL_Driver/Src/stm32c0xx_hal_tim.c",
            "stm32_hal/Drivers/STM32C0xx_HAL_Driver/Src/stm32c0xx_hal_tim_ex.c",
            "stm32_hal/Core/Src/system_stm32c0xx.c",
    ...
    module.addCMacro("STM32C031xx", "");

    // Startup file
    module.addAssemblyFile(b.path("stm32_hal/startup_stm32c031xx.s"));
}
